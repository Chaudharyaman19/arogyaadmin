...
export const defaultPartnershipPageSections: OpportunitySectionContent[] = [
  {
    ...
    subtitle: "Partner with Arogya Expo 2027 and be a part of India's leading platform for organic business, innovation, wellness and sustainability.",
  ...
  },
  {
    ...
    enabled: true,
    eyebrow: "WHY PARTNER",
    title: "WHY PARTNER WITH AROGYA EXPO 2027?",
    subtitle: "KEY BENEFITS",
...
export const defaultSubPartnershipSections: OpportunitySectionContent[] = [
  {
    ...
    subtitle: "Collaborate with Arogya Expo 2027 to expand your business network.",
