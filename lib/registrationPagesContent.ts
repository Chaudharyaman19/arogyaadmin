...
export const defaultBookAStandSections: LandingSectionContent[] = [
  ...
  },
  {
    ...
    title: "Arogya Expo 2027 (Global Edition)",
    description: "Step into Arogya Expo 2027, a leading global platform uniting the organic, natural, and sustainable industries under one roof. Whether you are discovering eco-friendly innovations or a corporate buyer seeking meaningful business connections, Organic Expo offers a high-value, curated experience with India's most trusted organic brands and manufacturers.",
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Refund & Cancellation Policy", description: "I have read and agree to the Refund & Cancellation Policy for Arogya Expo Stand Booking." },
      { title: "Privacy Policy Consent", description: "I have read and agree to the Privacy Policy of Arogya Expo." },
    ],
  },
];
...
export const defaultTermsAndConditionsSections: LandingSectionContent[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Scope of Services", description: "Arogya Expo 2027 is organized by Namo Gange Wellness Pvt. Ltd. to facilitate trade, exhibition, and networking in the organic and natural product sectors." },
...
export const defaultPrivacyPolicySections: LandingSectionContent[] = [
  ...
  },
  {
    ...
    items: [
      { title: "Scope & Applicability", description: "This policy applies to all visitors, exhibitors, buyers, sponsors, delegates and partners engaging with Arogya Expo 2027 through our website, registration forms, emails or events." },
