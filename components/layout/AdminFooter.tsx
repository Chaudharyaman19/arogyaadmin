      ...
      <div className="relative z-10 flex h-full items-center overflow-x-auto px-3 text-[10px] font-medium text-slate-600 lg:pr-[390px]">
        <div className="flex min-w-0 items-center gap-2">
          <span className="flex items-center gap-2 whitespace-nowrap">
            ...
            Arogya Bharat — Empowering Healthcare & Holistic Wellness.
          </span>
          <span className="h-5 w-px bg-slate-300" />
          <span className="whitespace-nowrap">© {new Date().getFullYear()} Arogya Expo. All rights reserved.</span>
          <span className="h-6 w-px bg-slate-300" />
          <span className="whitespace-nowrap">An Initiative of Namo Gange Trust</span>
          <span className="h-6 w-px bg-slate-300" />
          <Link href="https://arogyabharat.org/privacy-policy" target="_blank" rel="noopener noreferrer" className="whitespace-nowrap hover:text-slate-900">Privacy Policy</Link>
          <span className="h-6 w-px bg-slate-300" />
          <Link href="https://arogyabharat.org/terms" target="_blank" rel="noopener noreferrer" className="whitespace-nowrap hover:text-slate-900">Terms &amp; Conditions</Link>
          <span className="h-6 w-px bg-slate-300" />
          <a href="mailto:info@arogyabharat.org" className="whitespace-nowrap hover:text-slate-900">Support</a>
        </div>
      </div>
    </footer>
  );
