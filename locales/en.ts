...
export const en: TranslationDictionary = {
  ...
  login: {
    initiative: "An Initiative of Namo Gange Trust", portalTitle: "Admin & Operations Portal",
    compassionLine: "Promoting Organic, Sustainable & Healthy Living.", honorLine: "Connecting Farmers, Producers & Global Buyers.", dignityLine: "Empowering Sustainable Agriculture Nationwide.",
    values: {
      compassion: "100% Organic", compassionCopy: "Certified Organic Products & Agriculture",
      dignity: "Sustainable", dignityCopy: "Eco-friendly Practices & Healthy Living",
    ...
    secureTitle: "Secure. Confidential. Accountable.", secureCopy: "Your trust is our responsibility.", welcome: "Welcome Back!", continue: "Please login to continue to", portalName: "Arogya Expo Admin Portal",
